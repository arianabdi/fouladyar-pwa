...
const ChatSideBar = ({ sidebar, name }) => {
  ...
  return (
    <SimpleBar className={`nk-chat-profile ${sidebar ? "visible" : ""}`}>
      <div className="bordered-element chat-info-base">
        <div className="user-card user-card-s2 my-4">
          <UserAvatar className={"large-profile-image"}  size="md" text={findUpper(name)}></UserAvatar>
          ...
          <UncontrolledDropdown className="user-card-menu">
            ...
            <DropdownMenu end>
              <LinkList opt className="no-bdr">
                <LinkItem className="disabled" link={""} icon="eye">
                  مشاهده پروفایل
                </LinkItem>
                <LinkItem  className="disabled" link={""} tag="a" icon="na">
                  بلاک کردن کاربر
                </LinkItem>
              </LinkList>
            </DropdownMenu>
        ...
        <div className="chat-profile">
          <div className="chat-profile-group">
            <a
              ...
              id="chat-options"
            >
              <h6 className="title overline-title">تظیمات قالب</h6>
                ...
                <ul className="chat-profile-options">
                  <li>
                    <UncontrolledDropdown>
                      ...
                      >
                        <Icon name="circle-fill" className={`icon-circle bg-light }`}></Icon>
                        <span className="lead-text">رنگ چت</span>
                      </DropdownToggle>
                      <DropdownMenu>
          ...
          <div className="chat-profile-group">
            <a
              ...
              className="chat-profile-head"
            >
              <h6 className="title overline-title">تنظیمات عمومی</h6>
              <span className="indicator-icon">
                ...
                <ul className="chat-profile-settings">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <div>
                        <span className="lead-text">حالت بی صدا</span>
                        <span className="sub-text">زمانی پیغام جدیدی دریافت میکنید، پیام بی صدا خواهد بود.</span>
                      </div>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <div>
                        <span className="lead-text">با مشکل مواجه شدید!</span>
                        <span className="sub-text">لطفا در صورت بروز مشکل، مسئله را به پشتیبانی اطلاع دهید</span>
                      </div>
                    </a>
                  </li>
                </ul>
          ...
          <div className="chat-profile-group">
            <a
              ...
              className="chat-profile-head"
            >
              <h6 className="title overline-title">فایل ها</h6>
              <span className="indicator-icon">
