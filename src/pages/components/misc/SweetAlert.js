...
const SweetAlertPage = () => {
  ...
  const handleDefault2 = () => {
    Swal.fire({
      title: "The Internet?",
      textColor: "That thing is around?",
      focusConfirm: false,
    });
  };
  ...
  const handleSuccess = () => {
    Swal.fire({
      icon: "success",
      title: "Good Job",
      textColor: "You clicked the button",
      focusConfirm: false,
    });
  };
  ...
  const handleAdvanced1 = (e) => {
    Swal.fire({
      icon: "error",
      title: "Oops...",
      textColor: "Something went wrong",
      focusConfirm: false,
  ...
  const handleAdvanced3 = () => {
    Swal.fire({
      title: "Are you sure?",
      textColor: "You won't be able to revert this!",
      icon: "warning",
  ...
  const handleAdvanced4 = () => {
    Swal.fire({
      title: "Sweet!",
      textColor: "Modal with a custom image.",
