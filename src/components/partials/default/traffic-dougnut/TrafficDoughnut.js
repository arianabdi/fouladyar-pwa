      ...
      <div className="traffic-channel">
        ...
        <div className="traffic-channel-group g-2">
          <div className="traffic-channel-data">
            <div className="title">
              <span className="dot dot-lg sq" style={{ backgroundColor: "#798bff" }}></span>
          ...
          <div className="traffic-channel-data">
            <div className="title">
              <span className="dot dot-lg sq" style={{ backgroundColor: "#b8acff" }}></span>
          ...
          <div className="traffic-channel-data">
            <div className="title">
              <span className="dot dot-lg sq" style={{ backgroundColor: "#ffa9ce" }}></span>
              <span>Referrals</span>
            </div>
            <div className="amount">
          ...
          <div className="traffic-channel-data">
            <div className="title">
              <span className="dot dot-lg sq" style={{ backgroundColor: "#f9db7b" }}></span>
              <span>Others</span>
            </div>
            <div className="amount">
